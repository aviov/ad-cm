...
export class ApiStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ApiStackProps) {
    ...
    const coreApiRepository = new ecr.Repository(this, 'CoreApiRepository', {
    ...
    const integrationApiRepository = new ecr.Repository(this, 'IntegrationApiRepository', {
    ...
    const integrationApiTargetGroup = new elbv2.ApplicationTargetGroup(this, 'IntegrationApiTargetGroup', {
    ...
    const integrationApiTaskDefinition = new ecs.FargateTaskDefinition(this, 'IntegrationApiTaskDefinition', {
    ...
    const integrationApiLogDriver = new ecs.AwsLogDriver({
      logGroup,
    ...
    const coreApiContainer = coreApiTaskDefinition.addContainer('CoreApiContainer', {
      image: ecs.ContainerImage.fromEcrRepository(coreApiRepository, 'latest'),
    ...
    const integrationApiContainer = integrationApiTaskDefinition.addContainer('IntegrationApiContainer', {
      image: ecs.ContainerImage.fromEcrRepository(integrationApiRepository, 'latest'),
    ...
    const integrationApiService = new ecs.FargateService(this, 'IntegrationApiService', {
    ...
    new cdk.CfnOutput(this, 'CoreApiRepositoryUri', {
      value: coreApiRepository.repositoryUri,
    ...
    new cdk.CfnOutput(this, 'IntegrationApiRepositoryUri', {
      value: integrationApiRepository.repositoryUri,
